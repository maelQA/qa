...
export const useComponentBasesStore = defineStore('componentBases', () => {
    ...
    configurations = {'plugin-ee24f5ac-e15e-4ddd-baa4-0b4baedf90c9': getInheritedConfiguration({ ...require('@/components/plugins/plugin-ee24f5ac-e15e-4ddd-baa4-0b4baedf90c9/ww-config.js').default, name: 'plugin-ee24f5ac-e15e-4ddd-baa4-0b4baedf90c9' }),
